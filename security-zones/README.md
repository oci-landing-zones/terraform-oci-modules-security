...
- **enable_obp_checks**: Checks whether the user can deploy Security Zone resources in the Root compartment (tenancy). If set to true, Security Zone resources will not be allowed to be deployed in the Root compartment. If set to false, the check is removed and Security Zone resources are allowed to be deployed in the Root compartment. Default: true.
